...
import { ContactFormDrawer } from "@features/contact/components/contact-form-drawer";
...
export function FormatsSection() {
  ...
  return (
    <>
      ...
      <ContactFormDrawer open={isContactOpen} onOpenChange={setIsContactOpen} />
    </>
  );
}
